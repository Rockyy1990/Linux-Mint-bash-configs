...
echo ""
sleep 3
sudo nala install -y build-essential zenity gparted fakeroot ttf-mscorefonts-installer gdebi 
sudo nala install -y winbind needrestart gsmartcontrol 7zip preload
...
sudo nala update 
sudo nala install -y pipewire pipewire-pulse wireplumber pavucontrol pulseaudio-utils libspa-0.2-bluetooth pipewire-v4l2
